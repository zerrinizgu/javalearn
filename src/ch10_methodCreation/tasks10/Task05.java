...
dortislem(islem,sayi1,sayi2);
    ...
    private static void bol(double sayi1, double sayi2) {System.out.println(sayi1/sayi2);
    }

    private static void carp(double sayi1, double sayi2) {System.out.println(sayi1*sayi2);
    }

    private static void cikar(double sayi1, double sayi2) {System.out.println(sayi1-sayi2);
    }
}
